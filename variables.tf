...
variable "logging_project_number" {
  description = "Lgging Project Number"
  type        = string
}
...
variable "artifact_publish_project_number" {
  description = "Publish Artifacts Project Number for ML Projects"
  type        = string
}

variable "artifact_publish_project_name" {
  description = "Publish Artifacts Project Name"
  type        = string
}
