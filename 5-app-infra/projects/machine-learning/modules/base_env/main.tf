...
module "composer" {
  ...
  source = "git::https://source.developers.google.com/p/prj-c-bu3service-catalog-4qwt/r/service-catalog//modules/composer?ref=main"
...
module "big_query" {
  count  = var.env != "development" ? 1 : 0
  source = "git::https://source.developers.google.com/p/prj-c-bu3service-catalog-4qwt/r/service-catalog//modules/bigquery?ref=main"
...
module "metadata" {
  count  = var.env != "development" ? 1 : 0
  source = "git::https://source.developers.google.com/p/prj-c-bu3service-catalog-4qwt/r/service-catalog//modules/metadata?ref=main"
...
module "bucket" {
  count  = var.env != "development" ? 1 : 0
  source = "git::https://source.developers.google.com/p/prj-c-bu3service-catalog-4qwt/r/service-catalog//modules/bucket?ref=main"
...
module "tensorboard" {
  count  = var.env != "development" ? 1 : 0
  source = "git::https://source.developers.google.com/p/prj-c-bu3service-catalog-4qwt/r/service-catalog//modules/tensorboard?ref=main"
