...
output "service_catalog_crypto_key" {
  description = "key created in project"
  value       = module.composer_cloudbuild_project[0].project_crypto_key
}
...
#   value       = try(module.composer_cloudbuild_project[0].terraform_service_accounts, {})
# }

# output "composer_repos" {
#   description = "CSR's to store source code for composer repo"
#   value       = try(module.composer_cloudbuild_project[0].repos, toset([]))
# }

# output "composer_artifact_buckets" {
#   description = "GCS Buckets to store Cloud Build Artifacts"
#   value       = try(module.composer_cloudbuild_project[0].artifact_buckets, {})
# }

# output "composer_state_buckets" {
#   description = "GCS Buckets to store TF state"
#   value       = try(module.composer_cloudbuild_project[0].state_buckets, {})
# }

# output "composer_log_buckets" {
#   description = "GCS Buckets to store Cloud Build logs"
#   value       = try(module.composer_cloudbuild_project[0].log_buckets, {})
# }

# output "composer_plan_triggers_id" {
#   description = "CB plan triggers"
#   value       = try(module.composer_cloudbuild_project[0].plan_triggers_id, [])
# }

# output "composer_apply_triggers_id" {
#   description = "CB apply triggers"
#   value       = try(module.composer_cloudbuild_project[0].apply_triggers_id, [])
# }
