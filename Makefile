...
docker_test_lint:
	docker run --rm -it \
		-e ENABLE_PARALLEL=0 \
		-e DISABLE_TFLINT=1 \
		-e EXCLUDE_LINT_DIRS="\./examples/machine-learning-pipeline|\./docs/assets/terraform|\./5-app-infra/projects/service-catalog/ml_business_unit/shared|\./5-app-infra/projects/artifact-publish/ml_business_unit/shared" \
		-v $(CURDIR):/workspace \
