...
dag = DAG(
    ...
    # Set the schedule interval (e.g., daily)
...
bqOperator = BigQueryCreateEmptyDatasetOperator(
    ...
    location=REGION,
    dataset_reference={"defaultEncryptionConfiguration": {
        "kmsKeyName": default_kms_key_name}},
    dag=dag,
)
...
[wait_for_traindata_ingest_op,
    wait_for_evaldata_ingest_op] >> training_op >> eval_op >> deploy_op >> monitoring_op
