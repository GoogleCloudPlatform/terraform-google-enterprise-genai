...
const (
	size            = 70
	readmeURL       = "https://github.com/GoogleCloudPlatform/terraform-google-enterprise-genai/blob/master/%s/README.md"
	...
	troubleQuotaURL = "https://github.com/GoogleCloudPlatform/terraform-google-enterprise-genai/blob/master/docs/TROUBLESHOOTING.md#billing-quota-exceeded"
