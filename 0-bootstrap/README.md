...
<td>Deploy a <a href="https://cloud.google.com/compute/">Compute Engine</a> instance in one of the machine learning projects using the infra pipeline setup in 4-projects.</td>
</tr>
</tbody>
</table>
