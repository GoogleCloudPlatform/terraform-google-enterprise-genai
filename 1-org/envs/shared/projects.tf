...
module "artifacts" {
  ...
  random_project_id_length = 4
  default_service_account  = "deprivilege"
  name                     = "${local.project_prefix}-c-artifacts"
  org_id                   = local.org_id
  billing_account          = local.billing_account
  folder_id                = google_folder.common.id
  ...
  labels = {
    ...
    application_name  = "org-artifacts"
    billing_code      = "1234"
    primary_contact   = "example1"
    secondary_contact = "example2"
    business_code     = "abcd"
  ...
  budget_alert_pubsub_topic   = var.project_budget.artifacts_alert_pubsub_topic
  budget_alert_spent_percents = var.project_budget.artifacts_alert_spent_percents
  budget_amount               = var.project_budget.artifacts_budget_amount
  budget_alert_spend_basis    = var.project_budget.artifacts_budget_alert_spend_basis
}


/******************************************
  Project for Service Catalog
*****************************************/
...
module "service_catalog" {
  ...
  random_project_id_length = 4
  default_service_account  = "deprivilege"
  name                     = "${local.project_prefix}-c-service-catalog"
  org_id                   = local.org_id
  billing_account          = local.billing_account
  folder_id                = google_folder.common.id
  ...
  labels = {
    environment       = "development"
    application_name  = "org-service-catalog"
    billing_code      = "1234"
    primary_contact   = "example1"
    secondary_contact = "example2"
    business_code     = "abcd"
  ...
  budget_alert_pubsub_topic   = var.project_budget.service_catalog_alert_pubsub_topic
  budget_alert_spent_percents = var.project_budget.service_catalog_alert_spent_percents
  budget_amount               = var.project_budget.service_catalog_budget_amount
  budget_alert_spend_basis    = var.project_budget.service_catalog_budget_alert_spend_basis
}
