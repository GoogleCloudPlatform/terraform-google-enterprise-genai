...
locals {
  ...
  network_name                  = "composer-vpc-${local.region_short_code[var.region]}"
  subnetwork                    = "composer-primary-${local.region_short_code[var.region]}"
  services_secondary_range_name = "composer-services-primary-${local.region_short_code[var.region]}"
  cluster_secondary_range_name  = "pods-primary-${local.region_short_code[var.region]}"
  ...
  tags = ["composer-${local.region_short_code[var.region]}"]
