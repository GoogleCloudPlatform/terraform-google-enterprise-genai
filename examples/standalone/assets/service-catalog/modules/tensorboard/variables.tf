...
variable "name" {
  type        = string
  description = "The name of the tensorboard."
}
...
variable "kms_key_name" {
  type        = string
  description = "The KMS key to be used on the keyring, if not specified will use the default key created by the standalone example"
  default     = ""
}
