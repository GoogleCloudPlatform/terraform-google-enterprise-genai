...
module "composer" {
  ...
  source = "git::https://source.developers.google.com/p/SERVICE_CATALOG_PROJECT_ID/r/service-catalog//modules/composer?ref=main"
...
module "big_query" {
  ...
  source = "git::https://source.developers.google.com/p/SERVICE_CATALOG_PROJECT_ID/r/service-catalog//modules/bigquery?ref=main"
